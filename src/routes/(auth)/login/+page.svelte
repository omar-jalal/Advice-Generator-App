...
<main in:fade out:fade class="flex flex-col gap-8 justify-center items-center min-h-screen sm:w-10/12 md:w-3/4 lg:w-1/2 xl:w-[25%] m-auto transition-all duration-300">
    <a href="/">
